...
Shuffle money-jars. This project is [ledger-axon](https://github.com/jeroenvanmaanen/ledger-axon), but in [Rust](https://rust-lang.org/) (using [Dioxus](https://dioxuslabs.com/)). Like `ledger-axon`, `sguffle` is a ledger for multiple bank accounts loosely arranged according to the six-jars principle.
